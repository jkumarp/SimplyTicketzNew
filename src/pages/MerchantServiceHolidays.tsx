...
const MerchantServiceHolidays = () => {
  ...
  // Fetch holidays for this service (server-side paginated)
  const { data: holidaysResponse, isLoading: isLoadingHolidays, isFetching: isFetchingHolidays } = useQuery({
    queryKey: ["merchant-service-holidays", serviceId, page, pageSize],
    queryFn: async () => {
      ...
      const res = await fetch(
        `${API_URL}/merchant-service-holidays?${params.toString()}`,
        {
          headers: getAuthHeader(),
        },
      );
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-500">
                  Configure non-working days for {service?.name}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="lg:col-span-2 shadow-md border-slate-200">
              <CardHeader>
                ...
                <CardDescription>
                  Upcoming and past holidays for this service
                </CardDescription>
              </CardHeader>
